...
// $.removeClass(buttonElem, "btn"); // - Удаляем класс.

$.toggleClass(buttonElem, "111111"); // - Добавляем класс.

$.attr(listA, "href", "Lalalla"); // - Добавляем атрибут и значение;

let a = $.attr(listA, "href"); // -- Получаем значение атрибута
console.log(a); 

$.appendElem(listA, span); // Помещаем элемент в конец.

$.appendElem(listA, buttonElem, span); // Помещаем элемент перед предыдущим.
console.log(listA);
